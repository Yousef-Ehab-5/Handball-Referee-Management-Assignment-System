...
This project is developed for educational and organizational purposes and may be adapted for sports federations, leagues, and referee committees.

Suggested Repository Name
handball-referee-management-system
smart-referee-assignment-system
refsync
referee-scheduler
match-official-management-system

My favorite is RefSync because it's short, professional, and sounds like a real product rather than a university project.
